...
ax1.plot(time_bins[1:], success_hist, 'r-', color="blue", label="Transfers Started")
ax1.plot(time_bins[1:], failure_hist, 'r-', color="red", label="Did not start")
...
fig.savefig("started_vs_did_not_start.png", dpi=300)
