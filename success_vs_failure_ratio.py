...
#ticks = np.arange(1443629990,1443758764,600)
...
fig = plt.figure()
print(len(success_ratio_list), len(time_bins[1:]))
ax1 = fig.add_subplot(111)
ax1.plot(time_bins[1:], success_ratio_list, color='blue')
ax1.set_ylabel("Percentage of Retrieved vs Requested")

#print(success_ratio_list, total_requested, reversed_total_retrieved)
#ax2 = fig.add_subplot(212)
#ax2.bar(time_bins[1:], total_requested, width=0.5,  color='r')
#ax2.bar(time_bins[1:], reversed_total_retrieved, width=0.5, color='b')
...
fig.savefig("requested_retrieved_percentage.png", dpi=300)
